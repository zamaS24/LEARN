    ...
    with dpg.window(label="Dear PyGui Demo", width=800, height=800, on_close=_on_demo_close, pos=(100, 100), tag="__demo_id"):
        ...
        with dpg.collapsing_header(label="Layout & Scrolling"):
            ...
            with dpg.tree_node(label="Simple Layouts"):
                ...
                with dpg.child_window(width=500, height=320, autosize_x=True):
                    with dpg.menu_bar():
                        dpg.add_menu(label="Menu Options")
...
with dpg.font_registry() as f:
        # we could call directly the dpg.bind(<the next line of code here>) and it will work
        myfont =  dpg.add_font("resources/fonts/Roboto_Mono/static/RobotoMono-Regular.ttf", 26)
...
dpg.create_viewport(title='Cypher', width=1080, height=720, resizable=False)
dpg.setup_dearpygui()
dpg.show_viewport()
