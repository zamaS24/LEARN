...
# Cette classe n'est pas incluse dans le programme principale.
# Ici on test l'idée de l'approche qu'on essaye de faire. 
class Algorithm: 
    ...
    def get_closed_itemsets(data, min_support):
        # where a closed itemset is one that is not a subset of any other frequent itemset with the same support.
...
file_path = 'C:/Users/monms/Desktop/LEARN/dearpygui/Apriori-Close/test.csv'
data = Algorithm.load_data(file_path)

frequent_itemsets = Algorithm.get_frequent_itemsets(data,0.1)
